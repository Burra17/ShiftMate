...
// Handlern för att avbryta en bytesförfrågan. Den säkerställer att endast den som skapade förfrågan kan ta bort den, och att passet återställs korrekt.
public class CancelSwapRequestCommandHandler : IRequestHandler<CancelSwapRequestCommand>
{
    private readonly IAppDbContext _context;

    public CancelSwapRequestCommandHandler(IAppDbContext context)
    {
        _context = context;
    }
