...
// Query handler för att hämta alla pass i en organisation som är upp till byte eller inte tillsatta.
public class GetClaimableShiftsQueryHandler : IRequestHandler<GetClaimableShiftsQuery, List<ShiftDto>>
{
    private readonly IAppDbContext _context;

    public GetClaimableShiftsQueryHandler(IAppDbContext context)
    {
        _context = context;
    }
