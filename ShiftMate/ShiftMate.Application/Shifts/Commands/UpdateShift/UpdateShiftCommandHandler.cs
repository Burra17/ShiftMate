...
// Command handler för att uppdatera ett pass, inklusive validering och krock-kontroll.
public class UpdateShiftCommandHandler : IRequestHandler<UpdateShiftCommand, bool>
{
    ...
    public UpdateShiftCommandHandler(IAppDbContext context, IValidator<UpdateShiftCommand> validator)
    {
        _context = context;
