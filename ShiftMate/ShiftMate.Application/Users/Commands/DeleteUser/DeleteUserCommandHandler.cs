...
// Handlern för att "ta bort" (inaktivera) en användare.
// Den säkerställer att användaren inte kan inaktivera sitt eget konto, att den tillhör samma organisation och att den inte redan är inaktiverad.
// Den markerar sedan användaren som inaktiv, frigör deras pass och avbryter alla väntande bytesförfrågningar som involverar dem.
