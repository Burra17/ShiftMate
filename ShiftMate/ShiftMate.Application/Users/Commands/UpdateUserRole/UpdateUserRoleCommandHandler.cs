...
// Handlern för att uppdatera en användares roll.
// Den validerar att den som gör ändringen inte ändrar sin egen roll, att den nya rollen är giltig och att användaren tillhör samma organisation innan den uppdaterar rollen i databasen.
public class UpdateUserRoleCommandHandler : IRequestHandler<UpdateUserRoleCommand, bool>
{
    ...
    public UpdateUserRoleCommandHandler(IAppDbContext context, IValidator<UpdateUserRoleCommand> validator)
    {
        _context = context;
