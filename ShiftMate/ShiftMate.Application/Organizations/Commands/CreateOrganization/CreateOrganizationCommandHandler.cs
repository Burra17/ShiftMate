...
// Command handler för att skapa en ny organisation.
public class CreateOrganizationCommandHandler : IRequestHandler<CreateOrganizationCommand, Guid>
{
    ...
    public CreateOrganizationCommandHandler(IAppDbContext context, IValidator<CreateOrganizationCommand> validator)
    {
        _context = context;
